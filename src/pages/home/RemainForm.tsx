...
function RemainForm({ onCancleClick, onYesClick, tab }: HomeFormProps) {
    ...
    return (
        <div className="relative bg-white rounded-[15px] w-[300px] px-[25px] py-[30px]">
            ...
            <svg onClick={onCancleClick} className="absolute right-10" width="27" height="28" viewBox="0 0 27 28" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <form className='flex flex-col gap-[20px]' onSubmit={handleSubmit}>
                ...
                <label className='font-opensans text-[24px] font-bold' htmlFor="amount">Nhập tiền trả</label>
                <input
                    type="number"
                    id='amount'
                    name="amount"
                    ...
                    className='rounded-[10px] px-[10px] py-[9px] border-1'
                />
                <div className="w-full flex justify-center">
                    <button type='submit' className='w-[180px] h-[60px] px-[20px] py-[10px] rounded-[20px] bg-[#BEF0FF] text-[#565656] font-bold font-monsterat text-[20px] hover:cursor-pointer focus:bg-[#0093CB] focus:text-white'>Xác nhận</button>
                </div>
            </form>
